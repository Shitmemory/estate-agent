  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex space-x-6">
              ...
              <Link href="/contact" className="hover:text-blue-200 transition-colors text-blue-200">
                Contact
              </Link>
            </nav>
      ...
      <section className="bg-gradient-to-r from-blue-800 to-blue-900 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-blue-100 max-w-2xl mx-auto">
            Get in touch with our property experts. We're here to help with all your property needs.
          </p>
        </div>
      </section>
            ...
            {contactMethods.map((method, index) => (
              <Card key={index} className="text-center hover:shadow-lg transition-shadow cursor-pointer">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700 font-semibold mb-1">{method.primary}</p>
                  <p className="text-gray-600 text-sm mb-3">{method.secondary}</p>
                  <p className="text-gray-500 text-xs mb-4">{method.description}</p>
                  <a
                    href={method.action}
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12">
                        ...
                        <div>
                          ...
                          >
                            ...
                            <SelectContent>
                              ...
                              <SelectItem value="letting">Letting a Property</SelectItem>
                        ...
                        <div>
                          ...
                          <Select value={formData.budget} onValueChange={(value) => handleInputChange("budget", value)}>
                            ...
                            <SelectContent>
                              ...
                              <SelectItem value="rental-under-1500">Rental: Under £1,500/month</SelectItem>
                              <SelectItem value="rental-1500-2500">Rental: £1,500-£2,500/month</SelectItem>
                              <SelectItem value="rental-over-2500">Rental: Over £2,500/month</SelectItem>
                            </SelectContent>
                          </Select>
                        </div>
                        <div>
                      ...
                      <div className="space-y-3">
                        <div className="flex items-center space-x-2">
                          ...
                          <Label htmlFor="newsletter" className="text-sm">
                            Subscribe to our newsletter for market updates and property insights
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <Checkbox
            ...
            <div className="space-y-6">
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-xl text-blue-800">Visit Our Office</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <a href="tel:02085685680" className="font-semibold text-gray-700 hover:text-blue-800">
                          020 8568 5680
                        </a>
                        <p className="text-gray-600 text-sm">Main office line</p>
                      </div>
                    </div>
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <button
                          onClick={() => copyEmailToClipboard("info@capital-estates.co.uk")}
                          className="font-semibold text-gray-700 hover:text-blue-800"
                        >
                          info@capital-estates.co.uk
                        </button>
                        <p className="text-gray-600 text-sm">Click to copy email</p>
                      </div>
                    </div>
                    <div className="flex items-center space-x-3">
                      <Globe className="h-5 w-5 text-blue-800" />
                      <div>
                        <p className="font-semibold text-gray-700">www.capital-estates.co.uk</p>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="border-t pt-3 mt-3">
                      <p className="text-sm text-gray-600">
                        <strong>Emergency Contact:</strong> Available 24/7 for existing clients and urgent property
                        matters
                      </p>
                    </div>
                  </div>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-xl text-blue-800">Department Contacts</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    {departments.map((dept, index) => (
                      <div key={index} className="border-b border-gray-200 pb-3 last:border-b-0">
                        ...
                        <div className="flex flex-col space-y-1 text-sm">
                          <a href={`tel:${dept.phone.replace(/\s/g, "")}`} className="text-blue-800 hover:underline">
                            {dept.phone}
                          </a>
                          <button
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-gray-600 text-sm mt-3">
                    Stay updated with our latest properties, market insights, and company news
                  </p>
                </CardContent>
              </Card>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Located in the heart of Leyton High Road</p>
          </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold text-gray-900 mb-4">Need Immediate Assistance?</h3>
            <p className="text-gray-600">Choose from our quick action options</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 text-sm mb-4">Schedule a consultation with our experts</p>
                <Link href="/book-appointment">
                  <Button className="bg-blue-800 hover:bg-blue-900">Book Now</Button>
                </Link>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 text-sm mb-4">Get an instant property valuation</p>
                <Link href="/book-appointment">
                  <Button className="bg-green-600 hover:bg-green-700">Get Valuation</Button>
                </Link>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 text-sm mb-4">Browse our latest property listings</p>
                <Link href="/properties">
                  <Button className="bg-purple-600 hover:bg-purple-700">View Properties</Button>
                </Link>
              </CardContent>
            </Card>
          </div>
