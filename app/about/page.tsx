...
const timeline = [
  ...
  },
  {
    year: "2008",
    title: "Expansion",
    description: "Expanded services to include comprehensive property management and investment advisory.",
    milestone: "Reached 100+ properties under management",
  },
  {
    year: "2012",
    title: "Recognition",
    description: "Received first industry award for customer service excellence and local market expertise.",
    milestone: "Won 'Local Estate Agent of the Year'",
  },
  {
    year: "2016",
    title: "Digital Innovation",
    description: "Launched advanced digital marketing platform and online property management portal.",
    milestone: "Introduced virtual property tours",
  },
  {
    year: "2020",
    title: "Resilience",
    description: "Adapted quickly to market changes, maintaining service excellence during challenging times.",
    milestone: "Achieved 98% client satisfaction rating",
  },
  {
    year: "2024",
    title: "Excellence",
    description: "Celebrating 20 years of service with over 500 successful sales and 300+ managed properties.",
...
const values = [
  {
    ...
    examples: ["Personalized service plans", "24/7 client support", "No hidden fees policy"],
  },
  {
    icon: Shield,
    title: "Integrity & Transparency",
    description: "We believe in honest, transparent dealings with complete disclosure at every step.",
    examples: ["Clear fee structures", "Regular progress updates", "Honest market assessments"],
  },
  {
    icon: Target,
    title: "Results-Driven",
    description: "We're committed to delivering measurable results that exceed expectations.",
    examples: ["Faster sale times", "Higher price achievements", "Proven track record"],
  },
  {
    icon: Users,
    title: "Community Focus",
    description: "As local specialists, we're invested in the communities we serve.",
    examples: ["Local market expertise", "Community partnerships", "Neighborhood knowledge"],
  },
  {
    icon: TrendingUp,
    title: "Continuous Innovation",
    description: "We embrace new technologies and methods to improve our service delivery.",
    examples: ["Digital marketing tools", "Virtual property tours", "Online client portals"],
  },
  {
    icon: Handshake,
    title: "Professional Excellence",
    description: "Maintaining the highest professional standards through continuous training and development.",
    examples: ["Industry qualifications", "Regular training programs", "Professional memberships"],
  },
]
...
const teamMembers = [
  ...
  },
  {
    ...
    role: "Head of Sales",
    experience: "12 years",
    qualifications: ["NAEA Qualified", "Negotiation Specialist", "Property Law Certified"],
  ...
  },
  {
    ...
    experience: "10 years",
    qualifications: ["ARLA Qualified", "Property Management Certified", "Legal Compliance Expert"],
  ...
  },
  {
    ...
    experience: "8 years",
    qualifications: ["NAEA Member", "First-Time Buyer Specialist", "Investment Advisory Certified"],
  ...
  },
  {
    ...
    experience: "6 years",
    qualifications: ["ARLA Licensed", "Maintenance Coordination", "Tenant Relations Expert"],
  ...
  },
  {
    ...
    experience: "5 years",
    qualifications: ["Digital Marketing Certified", "Photography Professional", "Social Media Expert"],
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex space-x-6">
              ...
              <Link href="/about" className="hover:text-blue-200 transition-colors text-blue-200">
                About
              </Link>
      ...
      <section className="bg-gradient-to-r from-blue-800 to-blue-900 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-blue-100 max-w-2xl mx-auto">
            Twenty years of excellence in East London property services, built on trust, expertise, and community
            commitment
          </p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-700 mb-4 text-lg">
                Founded in 2004, CAPITAL Letting & Estate Agents began with a simple mission: to provide exceptional
                property services that put clients first. What started as a small local agency has grown into East
                London's most trusted property professionals.
              </p>
              <p className="text-gray-700 mb-4">
                Over two decades, we've helped thousands of clients buy, sell, rent, and manage properties across East
                London. Our success is built on deep local knowledge, professional expertise, and an unwavering
                commitment to client satisfaction.
              </p>
              <p className="text-gray-700 mb-6">
                Today, we're proud to be recognized as industry leaders, but we never forget our roots as a
                community-focused business that treats every client like family.
              </p>
            ...
            <div className="relative h-96 rounded-lg overflow-hidden">
              <Image src="/images/storefront-updated.png" alt="CAPITAL Office" fill className="object-cover" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">Two decades of growth, innovation, and service excellence</p>
          </div>
                  ...
                  <div className={`w-1/2 ${index % 2 === 0 ? "pr-8 text-right" : "pl-8 text-left"}`}>
                    <Card className="hover:shadow-lg transition-shadow">
                      <CardContent className="p-6">
                        ...
                        <p className="text-sm font-semibold text-blue-800">{item.milestone}</p>
                      </CardContent>
                    </Card>
                  </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              The principles that guide everything we do and shape our relationships with clients and community
            </p>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Our experienced professionals are the heart of CAPITAL, bringing expertise, dedication, and local
              ...
              <Card key={index} className="hover:shadow-lg transition-shadow">
                <CardContent className="p-6">
                  ...
                  <div className="text-center mb-4">
                    ...
                    <p className="text-blue-800 font-semibold mb-1">{member.role}</p>
                  ...
                  <div>
                    <h5 className="font-semibold text-sm mb-2">Qualifications:</h5>
                    <div className="space-y-1">
                      {member.qualifications.map((qual, qualIndex) => (
                        <div key={qualIndex} className="flex items-center text-xs">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-blue-100 max-w-2xl mx-auto">
              Our commitment to excellence has been recognized by industry bodies and client organizations
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {achievements.map((achievement, index) => (
              <Card key={index} className="bg-blue-700 border-blue-600 text-white">
                <CardContent className="p-6 text-center">
                  ...
                  <Badge className="mb-3 bg-blue-600 text-white">{achievement.year}</Badge>
                  <h4 className="font-bold text-lg mb-2">{achievement.award}</h4>
                  <p className="text-blue-100 text-sm mb-3">{achievement.organization}</p>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">Numbers that reflect our commitment to excellence and client success</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center p-6 bg-purple-50 rounded-lg">
              ...
              <div className="text-3xl font-bold text-purple-800 mb-2">2000+</div>
              <div className="text-gray-600">Happy Clients</div>
            </div>
            <div className="text-center p-6 bg-yellow-50 rounded-lg">
              <Star className="h-12 w-12 text-yellow-800 mx-auto mb-4" />
              <div className="text-3xl font-bold text-yellow-800 mb-2">4.9/5</div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold text-gray-900 mb-4">Community Commitment</h3>
            <p className="text-gray-600 max-w-2xl mx-auto">
              We're proud to be part of the East London community and actively support local initiatives
            </p>
          </div>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                ...
                <p className="text-gray-700 text-sm">
                  Supporting local charities through donations, fundraising events, and volunteer work.
                </p>
              </CardContent>
            </Card>
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                ...
                <p className="text-gray-700 text-sm">
                  Sponsoring and participating in local events, festivals, and community gatherings.
                </p>
              </CardContent>
            </Card>
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                ...
                <p className="text-gray-700 text-sm">
                  Supporting local businesses and contributing to the economic growth of East London.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-16 bg-blue-800 text-white">
        <div className="container mx-auto px-4 text-center">
          <h3 className="text-3xl font-bold mb-4">Ready to Work with CAPITAL?</h3>
          <p className="text-blue-100 mb-8 max-w-2xl mx-auto">
            Experience the difference that 20 years of expertise and community commitment can make for your property
            journey
          </p>
